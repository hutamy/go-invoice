  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white via-primary-50/50 to-sky-50/40">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        {/* Header */}
        <div className="mb-12">
          <h1 className="text-5xl font-bold text-primary-900 mb-4 tracking-tight">Settings</h1>
          <p className="text-xl text-primary-600 font-light">Manage your account and preferences</p>
        </div>
        ...
        {activeTab === 'profile' && (
          <div className="bg-white/70 backdrop-blur-sm rounded-xl shadow-xl border border-white/20">
            <div className="px-8 py-6 border-b border-primary-200/30">
              <h3 className="text-xl font-bold text-primary-900">Profile Information</h3>
              <p className="text-sm text-primary-600 mt-2">Update your personal information and contact details.</p>
            </div>
            <form onSubmit={profileForm.handleSubmit(onSubmitProfile)} className="p-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                  ...
                  {profileForm.formState.errors.name && (
                    <p className="mt-2 text-sm text-red-600 font-medium">{profileForm.formState.errors.name.message}</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  {profileForm.formState.errors.email && (
                    <p className="mt-2 text-sm text-red-600 font-medium">{profileForm.formState.errors.email.message}</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  {profileForm.formState.errors.phone && (
                    <p className="mt-2 text-sm text-red-600 font-medium">{profileForm.formState.errors.phone.message}</p>
                  )}
                </div>
                ...
                <div className="md:col-span-2">
                  ...
                  {profileForm.formState.errors.address && (
                    <p className="mt-2 text-sm text-red-600 font-medium">{profileForm.formState.errors.address.message}</p>
                  )}
                </div>
              </div>
        ...
        {activeTab === 'banking' && (
          <div className="bg-white/70 backdrop-blur-sm rounded-xl shadow-xl border border-white/20">
            <div className="px-8 py-6 border-b border-primary-200/30">
              <h3 className="text-xl font-bold text-primary-900">Banking Information</h3>
              <p className="text-sm text-primary-600 mt-2">Update your banking details for invoice payments.</p>
            </div>
            <form onSubmit={bankingForm.handleSubmit(onSubmitBanking)} className="p-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="md:col-span-2">
                  ...
                  {bankingForm.formState.errors.bank_name && (
                    <p className="mt-2 text-sm text-red-600 font-medium">{bankingForm.formState.errors.bank_name.message}</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  {bankingForm.formState.errors.bank_account_name && (
                    <p className="mt-2 text-sm text-red-600 font-medium">{bankingForm.formState.errors.bank_account_name.message}</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  {bankingForm.formState.errors.bank_account_number && (
                    <p className="mt-2 text-sm text-red-600 font-medium">{bankingForm.formState.errors.bank_account_number.message}</p>
                  )}
                </div>
              </div>

              <div className="bg-sky-50/60 border border-sky-200/60 rounded-2xl p-6 mt-8">
                <div className="flex">
        ...
        {activeTab === 'password' && (
          <div className="bg-white/70 backdrop-blur-sm rounded-xl shadow-xl border border-white/20">
            <div className="px-8 py-6 border-b border-primary-200/30">
              <h3 className="text-xl font-bold text-primary-900">Change Password</h3>
              <p className="text-sm text-primary-600 mt-2">Update your password to keep your account secure.</p>
            </div>
            <form onSubmit={passwordForm.handleSubmit(onSubmitPassword)} className="p-8">
              <div className="space-y-8">
                <div>
                  <label htmlFor="current_password" className="block text-sm font-semibold text-primary-700 mb-3">
                    Current Password
                  </label>
                  ...
                  {passwordForm.formState.errors.current_password && (
                    <p className="mt-2 text-sm text-red-600 font-medium">{passwordForm.formState.errors.current_password.message}</p>
                  )}
                </div>

                <div>
                  <label htmlFor="new_password" className="block text-sm font-semibold text-primary-700 mb-3">
                    New Password
                  </label>
                  <div className="relative">
                    <input
                  ...
                  {passwordForm.formState.errors.new_password && (
                    <p className="mt-2 text-sm text-red-600 font-medium">{passwordForm.formState.errors.new_password.message}</p>
                  )}
                </div>

                <div>
                  <label htmlFor="confirm_password" className="block text-sm font-semibold text-primary-700 mb-3">
                  ...
                  {passwordForm.formState.errors.confirm_password && (
                    <p className="mt-2 text-sm text-red-600 font-medium">{passwordForm.formState.errors.confirm_password.message}</p>
                  )}
                </div>
              </div>
        ...
        {activeTab === 'account' && (
          <div className="bg-white/70 backdrop-blur-sm rounded-xl shadow-xl border border-white/20">
            <div className="px-8 py-6 border-b border-primary-200/30">
              <h3 className="text-xl font-bold text-primary-900">Account Management</h3>
              <p className="text-sm text-primary-600 mt-2">Manage your account settings and data.</p>
            </div>
            <div className="p-8">
              <div className="space-y-8">
