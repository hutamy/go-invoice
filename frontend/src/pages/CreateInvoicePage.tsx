            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="flex justify-between items-center py-4">
                ...
                <div className="flex items-center space-x-6">
                  <Link
                    to="/dashboard"
                    className="text-primary-600 hover:text-primary-900 transition-colors font-medium"
                  >
                    Dashboard
                  </Link>
                  <Link
            ...
            <div className="mb-12">
              ...
              <div className="mt-6">
                ...
                <p className="text-xl text-primary-600 font-light">
                  Fill in the details below and see the live preview on the
                  right
                </p>
              </div>
            </div>
                  ...
                  <div className="ml-3">
                    ...
                    <div className="mt-2 text-sm text-blue-700">
                      <ul className="list-disc list-inside space-y-1">
                        <li>
                          Fill in your client's information and select them from
                          your client list
                        </li>
                        <li>
                          Add invoice items with descriptions, quantities, and
                          rates
                        </li>
                        <li>
                        ...
                        <li>
                          Save as draft to continue later, or send immediately
                          to your client
                        </li>
                      </ul>
                    </div>
