...
export default function Toast({ title, message, isError, setMessage }) {
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4 flex shrink-0">
                    <button
                      ...
                      className="inline-flex rounded-md cursor-pointer bg-white text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
                    >
